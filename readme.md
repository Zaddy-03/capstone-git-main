...
terraform {
  backend "s3" {
    bucket         = "neyo-capstone-remote-backend"    # you can set the name of your choice
    key            = "terraform/state.tfstate"
    region         = "eu-west-2"                       # you can set the region of your choice 
    dynamodb_table = "neyo-capstone-terraform-locking" # you can set the name of your choice
  }
}
```
